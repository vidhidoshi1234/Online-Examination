...
public class RegisterForm extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "India", "USA", "UK", "Indonesia" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String query="INSERT INTO Table1(Username,Password,First_Name,Last_Name,Middle_Name,Gender,Email_Address,Contact_No,Address,Country) VALUES('"+username+"','"+password+"','"+fname+"','"+lname+"','"+mname+"','"+gender+"','"+email+"','"+contact+"','"+address+"','"+country+"')";
